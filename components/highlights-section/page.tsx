...
function Cards() {
	return (
		<div className="flex gap-6">
			<Card icon={FaLocationDot} title='São Paulo e Região' description='Atendemos toda a região metropolitana de São Paulo com rapidez e eficiência.' />
			<Card icon={FaClock} title='2h de Chegada' description='Chegamos ao local em até 2 horas após o contato' />
			<Card icon={FaTruck} title='Visita Gratuita' description='Realizamos uma visita técnica gratuita para avaliar o problema e fornecer um orçamento preciso.' />
			<Card icon={FaShieldAlt} title='Análise Profissional' description='Preço justo definido somente após análise no local' />
		</div>
	);
}
